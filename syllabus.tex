...
\fancyhead{}
\fancyfoot{}
\fancyhead[LO,LE]{\footnotesize{NE 250 - Fall `17}}
...
\begin{itemize}
\item Class GitHub: \url{https://github.com/rachelslaybaugh/NE250}

\item Bcourses Site: \url{https://bcourses.berkeley.edu/courses/1463043}

\item Library: \url{http://www.lib.berkeley.edu/node}

\item KAERI: \url{http://atom.kaeri.re.kr/}

\item U.S.\ Nuclear Data\url{http://www.nndc.bnl.gov/}

\item Serpent official website: \url{http://montecarlo.vtt.fi/} 

\item DECF (1171 and 1111 Etcheverry): \url{http://www.decf.berkeley.edu/}

\item Free Python ebooks:\\
\url{http://www.leettips.org/2013/02/top-10-free-python-pdf-ebooks-download.html}

\item The Hacker Within: \url{http://thehackerwithin.github.io/berkeley/}

\item Software Carpentry: \url{http://software-carpentry.org/lessons.html}
\end{itemize}
...
\noindent Each week a
research paper will be assigned for reading. A small group of students will be selected
to prepare a critique of the paper based on an extensive
literature review. The students will present their critique and a class
discussion will follow. Each student will prepare a one or two paragraph response for each paper. See bCourses for assignment details.\\
...
\vspace*{.15in}
\subsection*{\textsc{\textcolor{blue}{Useful Campus Information}}}
\begin{itemize}
