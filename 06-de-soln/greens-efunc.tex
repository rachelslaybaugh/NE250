...
\end{align*}
%From before, we know the homogeneous solution can be written as a combination of exponentials, and the particular solution is $\frac{S_0 L^2}{D}$ giving
%\[
%\phi(x) = A \exp(-\frac{|x|}{L}) + B \exp(\frac{|x|}{L}) + \frac{S_0 L^2}{D} \:.
%\]
