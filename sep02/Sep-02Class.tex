...
\begin{center}
\includegraphics[scale=0.6]{nucleonbinding}
\end{center}
...
\begin{center}
\includegraphics[scale=0.6]{fissionproductyield}
\end{center}
...
\begin{center}
\includegraphics[scale=0.6]{fissionspectrum}
\end{center}
...
\begin{figure}%[t]\nonumber
\includegraphics[height=10 cm,width=10 cm]{fig2_1.jpg}
\end{figure}
